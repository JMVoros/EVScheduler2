...
CREATE TABLE chargepoint (
  Id int NOT NULL COMMENT 'unique identifier of this charging station',
  Available tinyint DEFAULT NULL COMMENT 'Whether this station is available. 0 means no, non-zero means yes',
  PRIMARY KEY (Id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
